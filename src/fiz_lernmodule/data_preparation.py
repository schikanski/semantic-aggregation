...
class DataPreparation:
    ...
    def prepare_data(self, percent_train, token_column):
        ...
        """
        self.inputs_as_tokens = self.data[token_column]
        self.inputs_as_embedding_idxs = self.tokens_to_embedding_idxs(self.inputs_as_tokens)
        ...
        # TODO: replace with something PyTorch-compatible
    ...
    def tokens_to_embedding_idxs(self, tokens):
        ...
        for idx in range(len(tokens)):
            single_tokenized_text = tokens.iat[idx]
            text_word_indexes = []
    ...
    def show_instance_details(self, train_instance_idx):
        ...
        print('\nOriginal:\n{}\n\nTokenized:\n{}\n\nTextAsEmbeddingIdx:\n{}\n\nLabelAsIdx:\n{}\n\nLabel:\n{}'.format(
            self.inputs_as_tokens.iat[train_instance_idx],
            ...
            self.label_id_to_text(self.labels_as_idxs[train_instance_idx])))
